...
describe('CatgeoryComponent', () => {
  let component: CatgeoryComponent;
  let fixture: ComponentFixture<CatgeoryComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(CatgeoryComponent);
